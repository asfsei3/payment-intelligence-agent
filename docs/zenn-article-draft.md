...
<!-- 公開前TODO: YouTube 動画ID 確定 → qQVKUWBQ5vk を全置換 → frontmatter の published を true に -->
...
- **国内サブスクリプション市場**(消費者向け定額制サービス中心)は、**1兆円規模に近づく拡大傾向** にあると言われています <!-- TODO citation: 矢野経済研究所 / ICT総研 等の市場調査を一次資料で確認 -->
- **国内オンラインBtoC EC市場**は、経済産業省の調査ベースでも **数十兆円規模で拡大が続いて** います <!-- TODO citation: 経済産業省「電子商取引に関する市場調査」最新版を確認 -->
